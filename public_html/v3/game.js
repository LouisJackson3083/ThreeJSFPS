class Game{
	constructor(){
		...
		this.playerXZInput = new THREE.Vector2(0, 0);
	...
	init() {
		...
		this.keyboard.domElement.addEventListener('keydown', (event) => game.onKeyDown(event));
		this.keyboard.domElement.addEventListener('keyup', (event) => game.onKeyUp(event));
	...
	checkWASDInputs() {
		...
		if ( this.keyboardEventsList.includes('w') && this.keyboardEventsList.includes('s') ) {
			this.playerXZInput.setY(0);
		}
		else if ( this.keyboardEventsList.includes('w') ) {
			this.playerXZInput.setY(1);
		}
		...
		if ( this.keyboardEventsList.includes('a') && this.keyboardEventsList.includes('d') ) {
			this.playerXZInput.setX(0);
		}
		else if ( this.keyboardEventsList.includes('a') ) {
			this.playerXZInput.setX(1);
		}
	...
	animate() {
		...
		if (this.playerXZInput.x != 0 || this.playerXZInput.y != 0 ) {
			this.player.moveXZ(dt, this.playerXZInput);
		}
